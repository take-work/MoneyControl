      ...
      <form id="formInput" name="formInput" method="post" action="moneyComplete.php">
        <tr>
          ...
          <td align="center" width="300">
            ...
            <input name="hundred" type="text" size="8" value="<?=htmlspecialchars($data['hundred'])?>" style="width:60px; height:40px" />
        ...
        <tr>
          ...
          <td align="center">
            ...
            <input name="five_hundred" type="text" size="8" value="<?=htmlspecialchars($data['five_hundred'])?>" style="width:60px; height:40px" />
        ...
        <tr>
          ...
          <td align="center">
            ...
            <input name="thousand" type="text" size="8" value="<?=htmlspecialchars($data['thousand'])?>" style="width:60px; height:40px" />
        ...
        <tr>
          ...
          <td align="center">
            ...
            <input name="five_thousand" type="text" size="8" value="<?=htmlspecialchars($data['five_thousand'])?>" style="width:60px; height:40px" />
        ...
        <tr>
          ...
          <td align="center">
            ...
            <input name="million" type="text" size="8" value="<?=htmlspecialchars($data['million'])?>" style="width:60px; height:40px" />
